    ...
    return Scaffold(
      ...
      body: Column(
        children: [
                ...
                Flexible(
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: _isDesignerTab ? Colors.black : Colors.white,
                      foregroundColor: _isDesignerTab ? Colors.white : Colors.black,
                      side: BorderSide(color: _isDesignerTab ? Colors.black : Colors.black),
          ...
          Expanded(
            child: _isDesignerTab
                ? _buildDesignerList()
                : const Center(
              child: Text('Browse Interior Designs feature coming soon!'),
            ),
          ),
        ],
      ),
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        final designers = snapshot.data!.docs
            .map((doc) => Designer.fromFirestore(doc.data() as Map<String, dynamic>, doc.id))
            .toList();
