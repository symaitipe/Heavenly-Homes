...
class OrderModel {
  ...
  final String? deliveryDate; // Added deliveryDate as an optional field
  ...
  OrderModel({
    ...
    this.deliveryDate, // Optional deliveryDate
    required this.items,
  });
  ...
  static Future<OrderModel> fromFirestore(DocumentSnapshot doc) async {
    ...
    if (data == null) {
      return OrderModel(
        ...
        deliveryAddress: 'N/A',
        paymentMethod: 'N/A',
        deliveryDate: null, // Set default value for deliveryDate
        items: [],
      );
    }
    ...
    return OrderModel(
      ...
      deliveryDate: data['deliveryDate'] as String?, // Add deliveryDate
      items: orderItems,
    );
  }
}
